          ...
          <div class="movieDataRight1">
            <div class="movieDataRight22">
              <div class="type">
                ...
                <span class="textall" style="line-height: 50px;" v-for="(item,index) in this.movieType1" :key="index">{{ item }}<span v-if="index < this.movieType.length-1" class="textall" style="font-size: 1em;">、</span></span><br>
              </div>
              <div class="director">
