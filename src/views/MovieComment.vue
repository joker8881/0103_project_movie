...
<div class="movieData">
  <button type="button" @click="getPerson()">按我看導演+演員</button>
      ...
      <thead style="background-color: rgb(194, 190, 190)" v-for="(item, index) of this.objPlayDirectors" :key="index">
        <th>{{ index + 1 }}</th>
      </thead>
      <tbody v-for="(item, index) of this.objPlayDirectors" :key="index">
        <tr>
